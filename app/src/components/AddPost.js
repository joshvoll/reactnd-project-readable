...
class AddPost extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (this.props.editPost) {
      editPostApi(this.props.match.params.id, val.title, val.body)
            .then(post => this.props.dispatch(editPost(post)))
            .then(() => {
      ...
      addNewPost(val).then(post => this.props.dispatch(addPost(post)))
            .then(() => { 
