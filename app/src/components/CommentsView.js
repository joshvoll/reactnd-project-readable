...
import { addComment as addNewComment } from '../actions/commentActions'
...
class Comments extends Component {
  ...
  handleSubmit = (e) => {
    ...
    addNewComment(val)
          ...
          .then(this.props.dispatch(updateCommentCount(this.props.id, this.props.match.params.category, "inc")))
      e.target.reset();
  }
