...
class PostCard extends Component {
  ...
  deletePost = (id) => {
    if (this.props.showComments) {
      removePost(id)
            .then(post => this.props.dispatch(deletePost(post))).then(() => { this.props.history.push(`/`)
      })
    } else {
  ...
  votePost = (id, option) => {
    ratePost(id, option)
          .then(post => this.props.dispatch(votePost(post)))
  }
                ...
                <div className="card">
                  <div className="card-content">
                    ...
                    <div className="chip postcard-author">
                      <img src="/images/josue.jpg" alt="Contact Person"/> {post.author}
                    </div>
                    <div className="row">
